...
encodedModelName = sys.argv[2] + '.h5'
classModelName = sys.argv[2] + '_2'
...
#load model
encodedModel = load_model( encodedModelName )
classModel = load_model( classModelName )

X_test = loadTestData()

code = encodedModel.predict( X_test )
predictions = classModel.predict_classes( code )
